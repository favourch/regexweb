    ...
    <div class="row">
        ...
        <div class="col s12 m10 l10 offset-l2 offset-m2">
            ...
            <div class="col s12 m8 l8">
                ...
                <a class="btn"  href="{{url('/deans/result-report')}}" style="position: absolute; bottom:10px; right:450px;">View Lecturer Reports</a>
                <a class="btn green" href="{{url('/deans/download-result-report')}}" style="position: absolute; bottom:10px; right:150px;">Download Lecturer Reports</a>
            </div>
            ...
            <script>
                $(document).ready(function () {
                    ...
                    function getStat(cid){
                        ...
                        var url = "{{url('/deans/get-stats/')}}/" + cid;
