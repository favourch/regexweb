<aside id="slide-out" class="side-nav white fixed">
    <div class="side-nav-wrapper">
        <div class="sidebar-profile">
            ...
            <div class="sidebar-profile-info">
                <a href="javascript:void(0);" class="account-settings-link">
                    ...
                    <p>{{Auth::user()->Dept->Faculty->name}}</p>
        ...
        <ul id="sidebar" class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
            <li class="no-padding"><a href="{{url('/deans')}}" class="collapsible-header waves-effect waves-grey active"><i class="material-icons circle regent sideicon">home</i>Home</a></li>
            <li class="no-padding">
                <a class="collapsible-header waves-effect waves-grey" href="{{url('/deans/approve-results')}}"><i class="material-icons circle regent1 sideicon ">feedback</i> Result Approvals</a>
            </li>
            <li class="no-padding">
                <a class="collapsible-header waves-effect waves-grey" href="{{url('/deans/messages')}}"> <i class="material-icons circle teal sideicon">email</i>Messages</a>
            </li>


            <li class="no-padding">
                <a class="collapsible-header waves-effect waves-grey" href="{{url('/deans/view-courses')}}"> <i class="material-icons circle green sideicon">file_upload</i>View Courses</a>
            </li>
